    ...
    <>
      <header className="bg-[#0056b3] text-white p-4 md:px-5 md:py-4 flex flex-col md:flex-row justify-between items-center shadow-md">
        ...
        <div className="flex flex-col md:flex-row gap-2 w-full md:w-auto items-center">
          ...
          {user && (
            <Link href="/favorites" className="px-3 py-2 bg-white text-[#333] border border-gray-300 font-bold hover:bg-gray-100 transition-colors shadow-sm rounded-sm text-center flex items-center gap-1.5">
              <span className="text-red-500">❤️</span> Ulubione ({favorites.length})
            </Link>
          )}
