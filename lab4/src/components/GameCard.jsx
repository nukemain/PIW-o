...
export default function GameCard({ game }) {
  ...
  return (
    <div className={`border border-gray-300 p-4 md:p-5 mb-5 bg-[#f9f9f9] rounded-md shadow-sm transition-all ${game.isPurchased ? "opacity-50 grayscale" : "hover:shadow-md"}`}>
      <h3 className="mt-0 text-[#004494] text-xl font-bold mb-2">{game.title} {game.isPurchased && <span className="text-red-600 text-sm ml-2">(WYPRZEDANE)</span>}</h3>
